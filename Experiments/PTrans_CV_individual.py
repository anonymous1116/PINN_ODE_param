...
def main(args):
    ...
    pretrain_dict = PTrans_pretrain(args.penalty, y_interpolate, t, model_pretrain, train_generator, variable_batch_size = 10, train_epochs = 5) #5000
    ...
    for train_idx, val_idx in kfold.split(ydata):
        ...
        results = PTrans_CV(args.penalty, torch.from_numpy(ydata), t, model_pretrain, train_generator, train_idx, val_idx, variable_batch_size = 10, train_epochs = 10) #10000
        num+=1
