...
python ./Experiments/FN_CV_individual.py --seed $seed --true_sigma 2e-1 --penalty 1.3e+01
#python ./Experiments/FN_penalty.py --seed $seed --true_sigma 2e-1 --penalty 20e+00
