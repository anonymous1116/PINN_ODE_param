...
#SBATCH --qos=standby
#SBATCH --array=0-699               # Create a job array with indices from 1 to 10
...
penalty_list=(0.0001 0.001 0.01 0.1 1 10 100)
...
python ./Experiments/PTrans_CV_individual.py --seed $seed --true_sigma 0.05 --penalty $penalty
