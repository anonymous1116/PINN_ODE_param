...
#python ./Experiments/FN_CV_individual.py --seed $seed --true_sigma 2e-1 --penalty 1e+00
python ./Experiments/FN_penalty.py --seed $seed --true_sigma 2e-1 --penalty 10e+00
