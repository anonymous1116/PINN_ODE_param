...
def main(args):
    ...
    output_dir = f"../depot_hyun/hyun/ODE_param/SIR/sig_{sci_str}/CV_optimal"
    ...
    penalty_list = [30.0, 50.0, 75.0, 100.0, 150.0, 200.0, 300.0]
    CV_error_list = []
    for j in range(len(penalty_list)):
        penalty = penalty_list[j]
        penalty_char = format(penalty, ".1e").replace(".", "_")
        CV_dir = f"../depot_hyun/hyun/ODE_param/SIR/sig_{sci_str}/lambda_{penalty_char}_CV"
